...
var file_internal_infra_grpc_protofiles_order_proto_rawDesc = []byte{
	...
	0x28, 0x02, 0x52, 0x0a, 0x66, 0x69, 0x6e, 0x61, 0x6c, 0x50, 0x72, 0x69, 0x63, 0x65, 0x32, 0x49,
...
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	0, // 0: pb.OrderService.Create:input_type -> pb.CreateOrderRequest
	1, // 1: pb.OrderService.Create:output_type -> pb.CreateOrderResponse
